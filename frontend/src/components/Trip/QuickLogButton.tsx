  ...
  return (
    <>
      <motion.button
        ...
        className="fixed bottom-6 left-6 z-40 w-16 h-16 bg-gradient-to-r from-theme-primary to-theme-secondary rounded-full shadow-2xl flex items-center justify-center hover:shadow-theme-primary/50 transition-shadow"
        title="Log Trip"
      >
